...
- For combat, item, reward, route or progression changes, read [docs/game-design-v0.2.md](docs/game-design-v0.2.md) and [docs/replayability.md](docs/replayability.md). The latter preserves the historical audit; current rules and delivery status are in [docs/build-interactions-v02.md](docs/build-interactions-v02.md) and [docs/post-victory-v02.md](docs/post-victory-v02.md). Player validation remains separate from implementation.
