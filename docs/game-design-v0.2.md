...
**Долгосрочная цель и актуальный аудит:** [зачем возвращаться на сотни часов](replayability.md). На 9 сентября в коде есть базовая метастатистика, но ещё нет полноценного цикла новых целей после победы. Описанные ниже новые открытия, справочник и разбор поражения остаются планом. Этапы 3–4 проверяют основу; следующие герои и финалы вводятся после проверки интереса повторных забегов.
