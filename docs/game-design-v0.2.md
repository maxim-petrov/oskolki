...
**Статус: этапы 1–3 внедрены 9 сентября 2026.** Пять поведений оружия, независимое качество, заточка, ранний пул реликвий, три готовые сборки и предварительный результат сдвига: [этап 1](weapon-builds-v02.md). Связанные ветки карты, кладовые, разные награды, три печати Цензора и раздельные последовательности случайности: [этап 2](route-rewards-v02.md). Старые активные сохранения продолжаются по прежним правилам. [Этап 3 — взаимодействия](build-interactions-v02.md) внедрён. Проверка баланса и интереса продолжается; числа не являются подтверждённым балансом.
...
Во время перетаскивания показываем гарантированный результат первой волны: попадания по целям, блок, энергию, фокус, яд, очищаемые угрозы и расход лимитов предметов. Отпускание фишки сразу выполняет сдвиг; стрелки у поля и на клавиатуре также действуют сразу. Отдельного подтверждения нет. Esc отменяет перетаскивание. Случайные каскады обозначаем как возможное продолжение без обещания результата. Намерение врага и ожидаемый урон герою обновляются после фактического действия; неизвестный исход не маскируется под точное предсказание.
...
**Долгосрочная цель и актуальный аудит:** [зачем возвращаться на сотни часов](replayability.md). Обновление 9 сентября: новые открытия, справочник, история, разбор поражения и первая порция целей после победы реализованы. Точные отличия и ограничения проверки: [post-victory-v02.md](post-victory-v02.md). Это подготовленная для наблюдений версия; условие интереса повторных забегов на людях ещё не проверено.
...
**Этапы 1–3 реализованы.** Для этапа 4 выполнен автоматический аудит обычных чисел; баланс не меняли без данных игроков. Для последующей проверки добавлены один герой, один финал, два преобразующих предмета и два испытания. Условия перехода в таблице не считаются пройденными по автоматическим тестам. Следующий шаг — наблюдение за игроками; третья область и большой каталог зависят от результатов.
